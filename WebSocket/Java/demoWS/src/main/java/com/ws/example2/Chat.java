...
package com.ws.example2;


import com.ws.example2.data.Message;
import com.ws.example2.data.MessageDecoder;
import com.ws.example2.data.MessageEncoder;
...
@ServerEndpoint(value="/chatimg", encoders={MessageEncoder.class}, decoders={MessageDecoder.class})
public class Chat {
