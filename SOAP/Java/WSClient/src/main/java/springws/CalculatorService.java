 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://ws.par.wsb/", wsdlLocation = "http://localhost:8080/services/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://ws.par.wsb/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/services/CalculatorService?wsdl");
    ...
    public CalculatorPortType getCalculatorPort() {
        return super.getPort(new QName("http://ws.par.wsb/", "CalculatorPort"), CalculatorPortType.class);
    }
    ...
    public CalculatorPortType getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.par.wsb/", "CalculatorPort"), CalculatorPortType.class, features);
    }
